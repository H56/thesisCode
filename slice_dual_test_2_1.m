...
%        [x, fs] = audioread(strcat(files_root_path, all_files(i).name));
        ...
        snr(t, 5) = snr(t, 5) + SNR(x, y51);

        y61 = dual_encode(x, w, k, a3, n(1 : 2));
        y62 = wav_quantize(y61, 8);
        y63 = awgn(y61, 30, 'measured');
        w61 = dual_decode(y61, num_watermark, k, n(1 : 2));
        w62 = dual_decode(y62, num_watermark, k, n(1 : 2));
        w63 = dual_decode(y63, num_watermark, k, n(1 : 2));
        snr(t, 6) = snr(t, 6) + SNR(x, y61);
