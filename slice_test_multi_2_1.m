...
parfor t = 1 : times
    for i = 1 : count
        ...
        result{t} = result{t} + [sum(w == w11) sum(w == w61) sum(w == w21) sum(w == w31) sum(w == w41) sum(w == w51);
                                 sum(w == w12) sum(w == w62) sum(w == w22) sum(w == w32) sum(w == w42) sum(w == w52);
                                 sum(w == w13) sum(w == w63) sum(w == w23) sum(w == w33) sum(w == w43) sum(w == w53)];
        if mod(i, 50) == 0
            disp([t i]);
