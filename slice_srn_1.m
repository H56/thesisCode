...
parfor t = 1 : times
    for i = 1 : count
        ...
        for j = 1 : length(a_set)
            ...
            y2 = slice_encode(x, w, k, a, n(1 : 4), 4);
			
            y3 = slice_encode(x, w, k, a, n(1 : 8), 4);
			
            y4 = slice_encode(x, w, k, a, n(1 : 16), 4);
			
            y5 = slice_encode(x, w, k, a, n(1 : 32), 4);
...
disp(ret);
save('/home/wujing/hupeng/result/slice_srn_1.mat');
