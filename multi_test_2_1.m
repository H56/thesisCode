...
%         [x, fs] = audioread(strcat(files_root_path, all_files(i).name));
        ...
        w23 = multi_bits_decode(y23, num_watermark, k, n(1 : 4));
        ...
        w33 = multi_bits_decode(y33, num_watermark, k, n(1 : 8));
        ...
        w43 = multi_bits_decode(y43, num_watermark, k, n(1 : 16));
        ...
        w53 = multi_bits_decode(y53, num_watermark, k, n(1 : 32));
...
disp(ret);
save('/home/wujing/hupeng/multi_test_2_1.mat');
