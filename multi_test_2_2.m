...
parfor t = 1 : times
    ...
    for i = 1 : count        
        ...
        mp3write(y11, fs, strcat('tmp/tmp', num2str(t), '.mp3')); [y12, fs] = mp3read(strcat('tmp/tmp', num2str(t), '.mp3'));
        y11 = 1.8 * y11;
        w11 = echo_decode(y11, num_watermark, k, n(1 : 2));
        w12= echo_decode(y12, num_watermark, k, n(1 : 2));

        y21 = multi_bits_encode(x, w, k, a, n(1 : 4));
        mp3write(y21, fs, strcat('tmp/tmp', num2str(t), '.mp3')); [y22, fs] = mp3read(strcat('tmp/tmp', num2str(t), '.mp3'));
        y21 = 1.8 * y21;
        ...
        mp3write(y31, fs, strcat('tmp/tmp', num2str(t), '.mp3')); [y32, fs] = mp3read(strcat('tmp/tmp', num2str(t), '.mp3'));
        y31 = 1.8 * y31;
        ...
        mp3write(y41, fs, strcat('tmp/tmp', num2str(t), '.mp3')); [y42, fs] = mp3read(strcat('tmp/tmp', num2str(t), '.mp3'));
        y41 = 1.8 * y41;
        ...
        mp3write(y51, fs, strcat('tmp/tmp', num2str(t), '.mp3')); [y52, fs] = mp3read(strcat('tmp/tmp', num2str(t), '.mp3'));
        y51 = 1.8 * y51;
        ...
        mp3write(y61, fs, strcat('tmp/tmp', num2str(t), '.mp3')); [y62, fs] = mp3read(strcat('tmp/tmp', num2str(t), '.mp3'));
        y61 = 1.8 * y61;
